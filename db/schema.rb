...
ActiveRecord::Schema.define(version: 20181013070854) do
  ...
  create_table "adverse_events", force: :cascade do |t|
    ...
    t.boolean  "is_related_to_drugs", limit: 1
  ...
  create_table "blood_biochemistry_after_therapies", force: :cascade do |t|
  ...
  add_index "blood_biochemistry_after_therapies", ["course_id"], name: "index_blood_biochemistry_after_therapies_on_course_id", using: :btree
  ...
  create_table "blood_routine_after_meds", force: :cascade do |t|
    t.integer  "medication_completion_id", limit: 4
    t.string   "name",                     limit: 255
    t.float    "value",                    limit: 24
    t.date     "sample_date"
  ...
  add_index "blood_routine_after_meds", ["medication_completion_id"], name: "index_blood_routine_after_meds_on_medication_completion_id", using: :btree

  create_table "blood_routine_after_therapies", force: :cascade do |t|
    t.integer  "course_id",   limit: 4
    t.string   "name",        limit: 255
    t.float    "value",       limit: 24
    t.date     "sample_date"
  ...
  add_index "blood_routine_after_therapies", ["course_id"], name: "index_blood_routine_after_therapies_on_course_id", using: :btree
  ...
  create_table "tumor_maker_after_medications", force: :cascade do |t|
    t.integer  "medication_completion_id", limit: 4
    t.float    "value",                    limit: 24
    t.date     "sample_date"
  ...
  add_index "tumor_maker_after_medications", ["medication_completion_id"], name: "index_tumor_maker_after_medications_on_medication_completion_id", using: :btree
