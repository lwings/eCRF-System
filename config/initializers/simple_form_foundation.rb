...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'row', hint_class: :field_with_hint, error_class: :error do |b|
    ...
    b.wrapper :right_input_wrapper, tag: :div, class: 'small-8 columns' do |ba|
      ba.use :input
  ...
  config.wrappers :s6_m4_l3, class: 'small-6 medium-4 large-3 columns', hint_class: :field_with_hint, error_class: :error do |b|
    b.use :html5
  ...
  config.wrappers :m6, class: 'medium-6 columns', hint_class: :field_with_hint, error_class: :error do |b|
    b.use :html5
    # b.optional :placeholder
    b.optional :maxlength
    b.optional :pattern
  ...
  config.wrappers :s6_m3_l2, class: 'small-6 medium-3 large-2 columns', hint_class: :field_with_hint, error_class: :error do |b|
    b.use :html5
    # b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
  ...
  config.wrappers :check_boxes, tag: 'div', hint_class: :field_with_hint, error_class: :error do |b|
    b.use :html5
    # b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
  ...
  config.wrappers :text, class:'medium-6  columns', hint_class: :field_with_hint, error_class: :error do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
  ...
  config.wrappers :date, class:'date medium-4 large-3 columns', hint_class: :field_with_hint, error_class: :error do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
  ...
  config.wrappers :datetime, class:'datetime medium-6 columns', hint_class: :field_with_hint, error_class: :error do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
  ...
  config.default_wrapper = :s6_m4_l3
end
